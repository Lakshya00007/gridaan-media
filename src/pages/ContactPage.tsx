        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.title} className="flex gap-4 p-5 bg-card rounded-2xl border border-border shadow-sm">
          ...
          <div className="md:col-span-2">
            {sent ? (
              <div className="bg-card rounded-2xl border border-border p-10 sm:p-12 text-center shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="bg-card rounded-2xl border border-border p-6 md:p-8 space-y-4 shadow-sm">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2.5 bg-bg border border-border rounded-xl text-xs text-text placeholder-text-secondary focus:outline-none focus:ring-2 focus:ring-primary/25 focus:border-primary"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full px-4 py-2.5 bg-bg border border-border rounded-xl text-xs text-text placeholder-text-secondary focus:outline-none focus:ring-2 focus:ring-primary/25 focus:border-primary resize-none"
                    placeholder="Your message..."
                  />
                </div>
                <button type="submit" className="flex items-center justify-center gap-1.5 w-full py-2.5 bg-primary text-white rounded-xl text-xs font-bold hover:bg-[#1d4ed8] transition-colors cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:ring-offset-2 focus-visible:ring-offset-bg">
                  <Send className="w-3.5 h-3.5" aria-hidden /> Send Message
                </button>
              </form>
            )}
          </div>
