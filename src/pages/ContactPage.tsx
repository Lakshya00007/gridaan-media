      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8">
            ...
            {[
              ...
              <div key={item.title} className="flex gap-4 p-5 bg-[#0B1224] dark:bg-[#0B1224]/50 rounded-xl border border-[#1E293B]/50 dark:border-[#1E293B]/50">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 dark:text-[#94A3B8]">{item.detail}</p>
          ...
          <div className="md:col-span-2">
            {sent ? (
              <div className="bg-[#0B1224] dark:bg-[#0B1224]/50 rounded-2xl border border-[#1E293B]/50 dark:border-[#1E293B]/50 p-12 text-center">
                <CheckCircle className="w-16 h-16 text-green-500 mx-auto mb-4" />
                <h2 className="text-2xl font-bold text-[#F8FAFC] dark:text-white mb-2">Message Sent!</h2>
                <p className="text-[#94A3B8] dark:text-[#94A3B8]">Thank you for reaching out. We'll get back to you within 24 hours.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="bg-[#0B1224] dark:bg-[#0B1224]/50 rounded-2xl border border-[#1E293B]/50 dark:border-[#1E293B]/50 p-6 md:p-8 space-y-5">
                <h2 className="text-xl font-bold text-[#F8FAFC] dark:text-white mb-2">Send us a message</h2>
