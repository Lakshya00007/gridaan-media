      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 shrink-0">
            ...
            <span className="text-xl font-bold bg-linear-to-r from-[#2563EB] to-[#1D4ED8] bg-clip-text text-transparent hidden sm:inline">
              Gridaan
            </span>
          </Link>
          ...
          <nav className="hidden lg:flex items-center gap-1">
            <Link to="/" className="px-3 py-2 text-sm font-medium text-gray-700 dark:text-[#F8FAFC] hover:text-[#2563EB] dark:hover:text-[#94A3B8] rounded-lg hover:bg-[#0B1224] dark:hover:bg-[#0B1224] transition-all">
              Home
            </Link>
            <div className="relative" onMouseEnter={() => setCategoriesOpen(true)} onMouseLeave={() => setCategoriesOpen(false)}>
              <button className="flex items-center gap-1 px-3 py-2 text-sm font-medium text-gray-700 dark:text-[#F8FAFC] hover:text-[#2563EB] dark:hover:text-[#94A3B8] rounded-lg hover:bg-[#0B1224] dark:hover:bg-[#0B1224] transition-all">
              ...
              {categoriesOpen && (
                <div className="absolute top-full left-0 w-64 bg-[#0B1224] dark:bg-[#0B1224] rounded-xl shadow-2xl border border-[#1E293B] dark:border-[#1E293B] py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  {categories.length === 0 && (
                    <div className="px-4 py-2.5 text-sm text-[#94A3B8]">No categories yet</div>
                  )}
                  <div className="border-t border-[#1E293B] dark:border-[#1E293B] mt-1 pt-1">
                    <Link to="/categories" className="block px-4 py-2.5 text-sm text-[#2563EB] dark:text-[#94A3B8] font-medium hover:bg-[#0B1224] dark:hover:bg-[#0B1224]">
                      View all categories →
                    </Link>
                  </div>
                </div>
            ...
            <Link to="/trending" className="px-3 py-2 text-sm font-medium text-gray-700 dark:text-[#F8FAFC] hover:text-[#2563EB] dark:hover:text-[#94A3B8] rounded-lg hover:bg-[#0B1224] dark:hover:bg-[#0B1224] transition-all">
              Trending
            </Link>
            <Link to="/tutorials" className="px-3 py-2 text-sm font-medium text-gray-700 dark:text-[#F8FAFC] hover:text-[#2563EB] dark:hover:text-[#94A3B8] rounded-lg hover:bg-[#0B1224] dark:hover:bg-[#0B1224] transition-all">
              Tutorials
            </Link>
            <Link to="/videos" className="px-3 py-2 text-sm font-medium text-gray-700 dark:text-[#F8FAFC] hover:text-[#2563EB] dark:hover:text-[#94A3B8] rounded-lg hover:bg-[#0B1224] dark:hover:bg-[#0B1224] transition-all">
              Videos
            </Link>
          </nav>
          ...
          <div className="flex items-center gap-2">
            {/* Search */}
            <button onClick={() => setSearchOpen(!searchOpen)} className="p-2 text-[#94A3B8] hover:text-[#2563EB] dark:text-[#94A3B8] dark:hover:text-[#94A3B8] rounded-lg hover:bg-[#0B1224] dark:hover:bg-[#0B1224] transition-all">
            ...
            {/* Dark mode */}
            <button onClick={toggleDarkMode} className="p-2 text-[#94A3B8] hover:text-[#2563EB] dark:text-[#94A3B8] dark:hover:text-[#94A3B8] rounded-lg hover:bg-[#0B1224] dark:hover:bg-[#0B1224] transition-all">
              {darkMode ? <Sun className="w-5 h-5" /> : <Moon className="w-5 h-5" />}
            </button>

            {/* Profile */}
<Link to="/dashboard" className="hidden sm:flex items-center gap-2 pl-2 pr-3 py-1.5 bg-linear-to-r from-[#2563EB] to-[#1D4ED8] text-white rounded-full text-sm font-medium hover:shadow-lg hover:shadow-[#2563EB]/20 dark:hover:shadow-[#1D4ED8]/30 transition-all">
              <User className="w-4 h-4" />
              <span className="hidden md:inline">Dashboard</span>
            </Link>

            {/* Mobile menu */}
            <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="lg:hidden p-2 text-[#94A3B8] hover:text-[#2563EB] dark:text-[#94A3B8] rounded-lg hover:bg-[#0B1224] dark:hover:bg-[#0B1224]">
          ...
          <div className="py-3 border-t border-[#1E293B] dark:border-[#1E293B] animate-in fade-in slide-in-from-top-2 duration-200">
            <form onSubmit={handleSearch} className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 bg-[#0B1224] dark:bg-[#0B1224] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-white transition-all"
                autoFocus
              />
            </form>
          </div>
